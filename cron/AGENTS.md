...
- **600-second inactivity watchdog** on cron sessions: `HERMES_CRON_TIMEOUT` controls the idle limit (`0` disables it), so runaway inactive loops cannot monopolise the scheduler.
