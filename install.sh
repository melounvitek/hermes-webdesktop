...
printf '%s  %s\n' 619296ca659db909c6b28f25d033fd73dfad500cea2b209c15f40d01fbf713b1 "$t/installer.pyz" | sha256sum --check --status || { echo 'Installer checksum mismatch; not executed.' >&2; exit 1; }
