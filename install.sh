...
printf '%s  %s\n' a39502b267d0982825e47f4ab7fbdbd89a027a5cecf9873479138e3268d5d7e9 "$t/installer.pyz" | sha256sum --check --status || { echo 'Installer checksum mismatch; not executed.' >&2; exit 1; }
