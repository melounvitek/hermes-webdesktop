...
from gateway.platforms.base import (
    ...
    cache_image_from_url, cache_image_from_bytes, cache_audio_from_url, cache_audio_from_bytes,
    cache_document_from_bytes, SUPPORTED_DOCUMENT_TYPES, _TEXT_INJECT_EXTENSIONS,
...
class DiscordAdapter(BasePlatformAdapter):
    ...
    async def send_update_prompt(
        ...
        if result.success and _metadata_marks_nonconversational(metadata):
            self._nonconversational_messages.mark_many([result.message_id])
        return result
        ...
        for att in all_attachments:
            ...
            if content_type.startswith("image/"):
                ...
                try:
                    ...
                    cached_path = cache_document_from_bytes(raw_bytes, att.filename or f"document{ext or '.bin'}")
                    if in_allowlist:
