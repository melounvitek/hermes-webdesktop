...
from hermes_cli.tools_config_post_setup import (  # noqa: F401 — re-exported for hermes_cli.tools_config.X callers and test patches
    ...
    _post_setup_lightpanda,
    _post_setup_agent_browser,
    _post_setup_camofox,
    _KITTENTTS_WHEEL_URL,
    _PIP_POST_SETUP_HOOKS,
    _post_setup_pip,
    _post_setup_spotify,
    _post_setup_langfuse,
    _post_setup_xai_grok,
    _POST_SETUP_HOOKS,
    _run_post_setup,
    ...
    active_restorable_python_tool_dependencies,
    restorable_python_tool_dependency,
    _agent_browser_installed,
    _camofox_installed,
    _lightpanda_installed,
    _cloud_agent_browser_installed,
    _POST_SETUP_READY,
)
