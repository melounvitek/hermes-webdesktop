...
def _reason(help: str):
    return _arg("--reason", default=None, help=help)


def _run_state_args(type_help: str):
    return (
        _arg("--state-type", choices=("status", "outcome"), default=None, help=f"With --state-name: {type_help}"),
...
def _triage_sweep_args(verb: str, Verb: str, noun: str):
    ...
    return (
        _arg("task_id", nargs="?", default=None, help=f"Task id to {verb} (required unless --all is given)"),
        _arg("--all", dest="all_triage", action="store_true", help=f"{Verb} every task currently in the triage column"),
        _arg("--tenant", default=None, help="When used with --all, restrict the sweep to this tenant"),
...
def _bulk_ids(verb: str):
    return _arg("--ids", nargs="+", default=None, help=f"Additional task ids to {verb} with the same reason (bulk mode)")


_TASK_ID = _arg("task_id")
_TASK_IDS = _arg("task_ids", nargs="+")
_SLUG = _arg("slug")
_TENANT = _arg("--tenant", default=None, help="Tenant namespace")
...
_STEP_HANDOFF = (
    _arg("--summary", default=None, help="Structured handoff summary. Falls back to --result if omitted."),
    _arg("--metadata", default=None, help="JSON dict of structured facts to store on the latest completed run."),
)
...
_BOARD_SPECS = [
    ...
    _cmd("create", [
        ...
        _arg("--name", default=None, help="Human-readable display name (defaults to Title Case of slug)"),
        _arg("--description", default=None, help="Optional description"),
        _arg("--icon", default=None, help="Optional emoji or single-character icon for the dashboard"),
        _arg("--color", default=None, help="Optional hex color (e.g. '#8b5cf6') for the dashboard"),
        _arg("--switch", action="store_true", help="Switch to the new board after creating it"),
        _arg("--default-workdir", default=None, help="Default workspace path for tasks created on this board"),
    ...
    _cmd("set-default-workdir", [
        _SLUG,
        _arg("path", nargs="?", default=None, help="Absolute path to use as default workdir. Omit to clear."),
    ...
    _cmd("import", [
        ...
        _arg("--as", dest="as_slug", default=None, help="Slug for the imported board (default: from the archive)"),
...
_SPECS = [
    ...
    _cmd("list", [
        ...
        _arg("--workflow-template-id", default=None, metavar="ID", help="Restrict to tasks with this workflow_template_id"),
    ...
    _cmd("set-model", [
        _TASK_ID,
        _arg("model", nargs="?", default=None, help="Model to pin the worker to (or 'none' to clear the override)"),
    ...
    _cmd("comment", [
        ...
        _arg("--max-len", type=int, default=None, help="Trim the stored comment body to this many characters"),
    ], help="Append a comment"),
    _cmd("attach", [
        _TASK_ID,
        _arg("path", help="Path to the local file to attach"),
        _arg("--content-type", default=None, help="MIME type (default: guessed from the file extension)"),
    ...
    _cmd("request-review", [
        _TASK_ID,
        _arg("--summary", default=None, help="What was implemented and how it was verified — shown to the reviewer."),
        _arg("--reviewer", default=None, help="Optional reviewer profile; reassigns the task before review dispatch."),
    ...
    _cmd("notify-list", [_arg("task_id", nargs="?", default=None), _json_flag()],
    ...
    _cmd("log", [_TASK_ID, _arg("--tail", type=int, default=None, help="Only print the last N bytes")],
