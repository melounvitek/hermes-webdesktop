...
def _run_install_with_heartbeat(
    ...
    try:
        ...
        # blocks the installer forever. Merged into stdout, the output
        # rides the pipe that IS drained. This module is imported when
        # `hermes update` starts, so an update running from an old base
        # executes the old copy regardless of the git reset — this
