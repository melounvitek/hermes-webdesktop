...
export const ar = defineLocale({
  ...
  settings: {
    ...
    notifications: {
      ...
      browser: {
        title: 'Hermes',
        body: 'هناك محادثة تحتاج إلى انتباهك.',
        enable: 'تفعيل إشعارات ما يحتاج إلى انتباهك في علامة التبويب هذه',
        disable: 'تعطيل في علامة التبويب هذه',
        test: 'إرسال إشعار تجريبي',
        description:
          'تنبيهات عامة لطلبات الموافقة والإدخال الجديدة التي تتلقاها علامة التبويب هذه. لا تتم مشاركة أي نص من المحادثة. النقر على التنبيه ينقل التركيز إلى علامة التبويب هذه فقط.',
        limits:
          'على أجهزة سطح المكتب فقط، ما دامت علامة التبويب هذه مفتوحة ومتصلة. لا تصدر تنبيهات للمحادثة النشطة ما دام التركيز عليها. قد تتلقى علامات التبويب وملفات تعريف المتصفح الأخرى طلبات مختلفة؛ فعّل التنبيهات في متصفح واحد فقط. تؤدي إعادة التحميل أو انقطاع الاتصال أو تغيير ملف التعريف أو تعليق التشغيل إلى إيقاف التنبيهات. لا تتوفر تنبيهات الاكتمال أو التنبيهات على الأجهزة المحمولة أو بعد إغلاق علامة التبويب. وقد تمنع إعدادات المتصفح ونظام التشغيل عرض الإشعارات حتى مع تفعيلها.',
        status: {
          off: 'التنبيهات متوقفة في علامة التبويب هذه، حتى لو سبق منح الإذن في المتصفح.',
          enabling: 'في انتظار الإذن والوصول الحصري إلى الإشعارات…',
          enabled:
            'الإشعارات مفعّلة في علامة التبويب هذه. لا يمكن لعلامات التبويب الأخرى من المصدر نفسه تفعيلها في الوقت ذاته.',
          requested: 'تم طلب إرسال إشعار. إذا لم يظهر شيء، فتحقق من إعدادات الإشعارات في المتصفح والنظام.',
          denied: 'الإشعارات محظورة. غيّر الإذن في إعدادات الموقع في المتصفح قبل إعادة التفعيل.',
          default: 'لم يُمنح الإذن. تبقى التنبيهات متوقفة؛ يمكنك محاولة التفعيل مجددًا.',
          insecure:
            'تحتاج الإشعارات إلى HTTPS أو سياق localhost موثوق. عناوين الشبكة المحلية التي تستخدم HTTP العادي غير مدعومة.',
          unsupported: 'الإشعارات أو التنسيق بين علامات التبويب لضمان استخدامها حصريًا غير متاح في هذا المتصفح.',
          disconnected: 'التنبيهات متوقفة لعدم توفر الاتصال. أعد الاتصال ثم فعّلها مجددًا.',
          otherTab: 'تتولى علامة تبويب أخرى الإشعارات. عطّلها هناك قبل تفعيلها هنا.',
          failed: 'فشل طلب الإشعار. التنبيهات متوقفة؛ تحقق من إعدادات المتصفح والنظام.',
          reset: 'تم إيقاف التنبيهات بعد تغيير علامة التبويب أو ملف التعريف. أعد تفعيلها عندما تكون مستعدًا.',
          limit: 'تم بلوغ الحد الأقصى لذاكرة الإشعارات. التنبيهات متوقفة؛ أعد تحميل علامة التبويب هذه للبدء مجددًا.'
        }
      },
      kinds: {
        approval: {
  ...
  rightSidebar: {
    terminalEmpty: 'لا توجد طرفية في هذا الملف الشخصي',
  ...
  preview: {
    ...
    serverSaved: 'تم الحفظ على الخادم',
    browserInvalidText: 'يتطلب التحرير ملفًا نصيًا كاملًا بترميز UTF-8 لا يتجاوز حجمه 512 KB.',
    browserOwnerChanged: 'تغيّر الاتصال أو الملف الشخصي. ارجع إلى الملف الأصلي لحفظ تعديلاتك.',
    browserDraftHint: 'تبقى التعديلات غير المحفوظة في علامة تبويب المتصفح هذه عند تبديل الملفات. احفظها قبل إعادة التحميل أو إغلاق المتصفح.',
    browserConflict: 'تغيّر الملف على الخادم. تم الاحتفاظ بمسودتك. انسخ التعديلات التي تحتاجها قبل تجاهلها وإعادة التحميل.',
    discardEditsTitle: 'تجاهل التعديلات غير المحفوظة؟',
    discardEditsBody: 'ستفقد مسودتك. لن يتغيّر الملف على الخادم.',
    browserSaveHint: 'جار تحرير ملف على الخادم. لا يوجد حفظ تلقائي.',
    browserSaveWarning:
      'يستبدل الحفظ الملف على الخادم وقد يعيد ضبط الأذونات والبيانات الوصفية الأخرى. قد تُستبدل التعديلات المتزامنة أيضًا. يُدعم UTF-8 فقط؛ وقد تتغير نهايات الأسطر.',
    console: {
